      ...
      <form
        ...
        <label>
          ...
          <input
            ...
            onChange={e => {
              ...
              let tagArr = tagString.split(",").map(tag => tag.trim());
        ...
        <div className='flex-end mx-3 mb-5 gap-4'>
          ...
          <button
            type='submit'
            disabled={submitting}
            className='px-5 py-1.5 text-sm bg-gradient-to-br from-purple-800 via-fuchsia-500 to-violet-500 rounded-full text-white'>
